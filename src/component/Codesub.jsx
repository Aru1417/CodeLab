    ...
    <>
      ...
      <div>
        <div className="scroll-smooth focus:scroll-auto">
          <div className="pt-5">
            <div className="flex justify-center gap-10 text-blue-800 text-lg ">
              <div className="theme-select outline outline-offset-2 outline-pink-400 rounded-md p-1">
                <label htmlFor="theme" className="pr-3 font-semibold">
                  Theme :
                </label>
              ...
              <div className="mode-select outline outline-offset-2 outline-pink-400 rounded-md p-1">
                <label htmlFor="mode" className="pr-5 font-semibold">
                  Language :
                </label>
                <select
                  name="mode"
            ...
            <div className="flex gap-[40%]">
              <div className="flex justify-start pl-20 gap-8">
                <label htmlFor="stdin" className="text-4xl mt-2">
                  Your Input :{" "}
                </label>
                <input
                  type="text"
                  ...
                  value={stdin}
                  name="stdin"
                  className="border-2 border-black-500 rounded-xl "
              ...
              <div className="flex justify-end">
                <button
                  className="flex border-2 font-semibold text-xl border-blue-500 mr-0.5 p-3 hover:text-white hover:bg-blue-500 transition-all ease-in-out"
                  onClick={send}
                >
                  {" "}
                  <img
                    ...
                    alt=""
                  />{" "}
                  <span> Compile and Execute</span>{" "}
                </button>
                <button
                  className="flex border-2 font-semibold text-xl border-blue-500 rounded-tr-lg rounded-br-lg p-3 hover:text-white hover:bg-blue-500 transition-all ease-in-out"
                  onClick={submit}
                >
                  {" "}
                  <img
